                        ...
                        <div class="col-md-6">
                            <div class="card shadow-sm">
                                <div class="card-body">
                                    ...
                                    <!-- Language Selection -->
                                    <form method="get" action="${pageContext.request.contextPath}/auth/register.jsp"
                                        class="mb-4">
                                        <div class="form-group">
                                            ...
                                            <select name="lang" id="lang" class="form-select"
                                                ...
                                                <option value="fr" ${param.lang=='fr' ? 'selected' : '' }>Français
                                                </option>
                                                <option value="rw" ${param.lang=='rw' ? 'selected' : '' }>Kinyarwanda
                                                </option>
                                                <option value="sw" ${param.lang=='sw' ? 'selected' : '' }>Kiswahili
                                                </option>
                                            </select>
                                        </div>
                                    </form>
