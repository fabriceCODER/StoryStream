        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <!-- Language Selection -->
                    <form method="get" action="register.jsp" class="mb-4">
                        <div class="form-group">
                            <label for="lang" class="form-label"><fmt:message key="register.language" /></label>
                    ...
                    <form action="UserController" method="post">
                        ...
                        <div class="form-group mb-3">
                            <label for="confirmPassword" class="form-label"><fmt:message key="register.confirmPassword" /></label>
