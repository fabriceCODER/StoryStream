               ...
               <section class="hero">
                    <div class="container text-center">
                         ...
                         <div class="d-grid gap-2 d-md-block">
                              <a href="${pageContext.request.contextPath}/auth/login" class="btn btn-light btn-lg me-2">
                         ...
                         <div class="col-md-4">
                              <div class="card feature-card shadow-sm">
                                   <div class="card-body text-center">
                                        ...
                                        <p class="text-muted">Browse through thousands of books across various genres
                                        </p>
                                   </div>
                              </div>
                         </div>
                         <div class="col-md-4">
                              <div class="card feature-card shadow-sm">
                                   <div class="card-body text-center">
                                        ...
                                        <p class="text-muted">Get your favorite books delivered right to your doorstep
                                        </p>
                                   </div>
                              </div>
                         </div>
